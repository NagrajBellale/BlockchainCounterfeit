...
main = Tk()
main.title("BLOCKCHAIN SOLUTIONS FOR PRODUCT VERIFICATION AND COUNTERFEIT PREVENTION")
...
font = ('times', 15, 'bold')
title = Label(main, text='BLOCKCHAIN SOLUTIONS FOR PRODUCT VERIFICATION AND COUNTERFEIT PREVENTION')
